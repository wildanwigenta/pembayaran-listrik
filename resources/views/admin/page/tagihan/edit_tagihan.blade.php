    ...
    <div class="card-body p-0">
        ...
        <div class="row">
            <div class="col-md-7">
                <div class="p-5">
                    <div class="text">
                        <h1 class="h4 text-gray-900 mb-4">Edit Data Tagihan</h1>
                    </div>
                    <form class="user" action="/admin/update_tagihan/{{ $tagihan->id_tagihan }}/{{ $tagihan->id_penggunaan }}" method="post" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" name="id_tagihan" id="exampleInputEmail"
                                placeholder="" value="{{ $tagihan->id_tagihan }}" hidden>
                        </div>

                        <small>user</small>
                            <b><h4>{{ $tagihan->name }}</h4></b>
